...
#imag="/data/data/org.test.myapp/files.app/"
...
walk2=[
       pygame.image.load("Новая папка (2)/1670754087.png"),
       pygame.image.load("Новая папка (2)/1670754090.png"),
        pygame.image.load("Новая папка (2)/1670754092.png"),
        pygame.image.load("Новая папка (2)/1670754094.png"),
...
hf=pygame.mixer.Sound("звук/2 - Фон для игры.mp3")
hf.play()
...
bul_left=6
bullet= pygame.image.load("снаряд/bullet (1).png").convert_alpha()
bul=[]
